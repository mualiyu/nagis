<header class="wrapper bg-soft-primary">
    ...
    <div class="container flex-lg-row flex-nowrap align-items-center">
        <div class="navbar-brand w-100">
          <a href="/">
            <img class="logo-dark" src="{{asset('/assets/img/nagis-logo.svg')}}" srcset="{{asset('/assets/img/nagis-logo.svg')}}" alt="" />
            <img class="logo-light" src="{{asset('/assets/img/nagis-logo.svg')}}" srcset="{{asset('/assets/img/nagis-logo.svg')}}" alt="" />
        ...
        <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
          <div class="offcanvas-header d-lg-none">
            <h3 class="text-white fs-30 mb-0">NAGIS</h3>
