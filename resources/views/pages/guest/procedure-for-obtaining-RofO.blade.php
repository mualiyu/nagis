...
@section('title')
Procedure and Cost for Obtaining RofO
@endsection
    ...
    <div class="container pt-19 pt-md-21 pb-18 pb-md-20 ">
      <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mx-auto">
          <h1 class="display-1 text-start text-white mb-3">Procedure and Cost for Obtaining RofO</h1>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="accordion accordion-wrapper mt-10" id="accordion">
            ...
            <div class="card accordion-item">
              <div class="card-header" >
               <div class="row">
               <div class="col-8 text-black">Procedure and Cost for Obtaining RofO</div>  <div class="col-4 text-end"><a href="./assets/download/ProcedureforobtainingRofO.pdf" target="_blank"> <i class="uil uil-folder-download"></i> Download </a></div>
               </div>
              </div>
            </div>
